...
namespace At0::Util
{
	...
	public:
		...
		static void Info(const std::string_view baseStr, uint16_t line, const std::string_view file, const std::string_view type, Args&&... args)
		{
			...
			Reyal::ZMessageBox(type, oss.str(), Reyal::ZMessageBox::Button::Ok, Reyal::ZMessageBox::Icon::Info, Reyal::ZMessageBox::Flags::DefaultDesktop);
		}
		...
		static void Warn(const std::string_view baseStr, uint16_t line, const std::string_view file, const std::string_view type, Args&&... args)
		{
			...
			Reyal::ZMessageBox(type, oss.str(), Reyal::ZMessageBox::Button::Ok, Reyal::ZMessageBox::Icon::Warn, Reyal::ZMessageBox::Flags::DefaultDesktop);
		}
