...
namespace At0::Reyal
{
    ...
    //    CreateDXGIFactory(__uuidof(pFactory), &pFactory);

    //    Microsoft::WRL::ComPtr<IDXGIAdapter> pAdapter;
    //    for (uint32_t i = 0; pFactory->EnumAdapters(i, &pAdapter) != DXGI_ERROR_NOT_FOUND; ++i)
    //    {
    ...
    //    // QUESTION:
    //    //  Are these kind of large comments a good way to describe every step (hard to miss, but large)
