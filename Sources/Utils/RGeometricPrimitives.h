...
namespace At0::Ray
{
	struct IndexedTriangleList
	{
		...
		static IndexedTriangleList Plane(
			const VertexLayout& layout, Vertex::Flags flags = Vertex::Position3D);
		...
		static IndexedTriangleList Cube(
			const VertexLayout& layout, Vertex::Flags flags = Vertex::Position3D);
		static IndexedTriangleList IcoSphere(
			const VertexLayout& layout, Vertex::Flags flags = Vertex::Position3D);
		static IndexedTriangleList UVSphere(const VertexLayout& layout, float radius,
			int latDiv = 12, int longDiv = 24, Vertex::Flags flags = Vertex::Position3D);
