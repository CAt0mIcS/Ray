...
namespace At0::Ray
{
	...
	class RAY_EXPORT WriteDescriptorSet
	{
	public:
		WriteDescriptorSet(
	...
	public:
		...
		virtual WriteDescriptorSet GetWriteDescriptor(uint32_t binding,
			VkDescriptorType descriptorType, const std::optional<OffsetSize>& offsetSize) const = 0;
	};
